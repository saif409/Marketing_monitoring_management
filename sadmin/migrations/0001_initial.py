    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('purpose_of_visit', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='sadmin.purposeofvisit')),
            ],
        ),
        migrations.CreateModel(
            name='CollectData',
            fields=[
                ...
                ('description', models.TextField()),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('company_review', models.IntegerField(choices=[(1, 'Onestar'), (2, 'Twostar'), (3, 'Threestar'), (4, 'fourstar'), (5, 'fivestar')])),
